...
import { EnvelopeOpenIcon, SpaceBetweenHorizontallyIcon } from "@radix-ui/react-icons"
...
export const Auth = ({ setIsAuth, setRoom }) => {
  ...
  return (
    <div className="App">
      ...
      <div>
        <div className="auth">
          <Card className=" auth-card w-[350px]">
            <CardHeader>
            ...
            <CardContent>
              ...
              <div className="grid w-full items-center gap-4">
                <div className="flex flex-col space-y-1.5">
                  <Button >
                    <EnvelopeOpenIcon className=" EOI mr-5 h-4 w-4" />
                    <br />
                    <span onClick={signInWithGoogle}> Sign in with Email</span>
                  </Button>
